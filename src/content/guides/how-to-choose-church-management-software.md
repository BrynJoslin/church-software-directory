...
For a fuller market view, browse the directory’s [church management systems](/categories/church-management/) and compare only products that fit the work you have defined.
...
Use the questions below at the end of the process, when you can relate answers to a real workflow. Our separate [GDPR questions for church software suppliers](/guides/uk-church-gdpr-questions/) provide a more detailed starting point for data-processing conversations.
