---
title: "Church records retention and software: what to keep, archive or delete"
...
1. Create one test record for each mapped type with a clear purpose and owner.
2. Apply the relevant access role, review date and archive/deletion action.
3. Check that an ordinary user cannot override a sensitive decision.
4. Export a test record and confirm it remains intelligible and access-controlled.
5. Move one item to archive and confirm its future review responsibility.
6. Delete a disposable test item and check user-visible deletion, audit evidence and backup explanation.
7. Simulate supplier exit: obtain the current export, return/deletion route and contract evidence.
...
The ICO recommends clear retention and erasure policies as good storage-limitation practice.[^ico-storage] The National Archives' charity-sector framework also treats retention, transfer and disposal as part of a records lifecycle rather than a one-off deletion exercise.[^national-archives] Use those principles to make reviews consistent, but get specialist advice where a record has legal, safeguarding or historic significance.
